...
\chapter{Analyse} \label{analyse}
	...
	\section[Soll-Analyse]{Soll-Analyse {\hfill \normalsize Milena Zahn}}
		...
		\begin{figure}[H]
			\subfigure[Persona Franzi]{\includegraphics[width=0.49\textwidth]{img/franzi1.png}} 
			\subfigure[Persona Gustav]{\includegraphics[width=0.49\textwidth]{img/gustav1.png}} 
			\subfigure[Persona Kassandra]{\includegraphics[width=0.49\textwidth]{img/kassandra1.png}} 
			\subfigure[Persona Walter]{\includegraphics[width=0.49\textwidth]{img/walter1.png}} 
