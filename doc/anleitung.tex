...
%
%\chapter{Grundlagen / Begrifflichkeiten}
%	\section{Internet der Dinge}
%	\section{SAP Cloud Platform (IoT Service)}
...
%		\subsection{Grundlegende Programmiersprachen}
%			\subsubsection{HTML}
%			\subsubsection{CSS}
%			\subsubsection{JavaScript}
%		\subsection{SAPUI5 Framework}
%	\section{Backend-Entwicklung}
%		\subsection{Framework node.js}
%			\subsubsection{Paketmanager npm}
%			\subsubsection{Routing Modul express.js}
%		\subsection{REST / HTTP}
%
%\chapter{Funktionales Konzept}
%	\section{Projektdefinition und -anforderungen}
%		\subsection{Projektdefinition}
%		\subsection{CI / Automated Build Pipelines}
%			\subsubsection{Travis.ci}
%			
%	\section{User-Research-Prozess ?}
%		\subsection{Entwurf Persona}
%		\subsection{Definition Use Case}
%
%	\section{Visualisierung der Daten}
%		\subsection{Datentypen}
%			\subsubsection{Eindimensionale Datentypen}
%			\subsubsection{Zweidimensionale Datentypen}
%			\subsubsection{Dreidimensionale Datentypen}
%		\subsection{Visualisierungsmöglichkeiten}
%
...
%\chapter{Backup}
%	\section{Überblick}
%		Verbrauchern \enquote{Informationen}\footnote{\cite[S. 8f.]{Stapelkamp.2013}} in Webanwendungen intuitiv verständlich darzustellen\autocite[Vgl.][S. 77ff]{Stapelkamp.2013}. 
%		\begin{table}[h!]
%			\centering
%			\begin{tabular}{lp{10cm}}
%				\textbf{Enduser} & \textbf{Visualisierung}\\\toprule
%				\texttt{Besucher der SAP Arena} & Visualisierung 
%				
%				--> wichtig wo ist welcher Parkplatz, aktueller Verkehr \\
%				\texttt{Facility Manger} & Einfache Darstellung der freien Parkplätze ausreichend 
%				
%				--> besitzt Kenntnisse über Gegebenheiten \\\bottomrule
%			\end{tabular}
%			\caption{\label{tab:Enduser}Übersicht über die Enduser und deren Bedürfnisse}
%		\end{table} 
%	
%			3D Darstellung\autocite[][S. 11]{Knaflic.2017} nur sinnvoll\autocite[ Vgl.] [S. 55]{Yau.2014} wenn Mehrwert, in diesem Fall (\cite[siehe][S. 54]{Stapelkamp.2013}) keine Vorteile. Ein Verweis auf die Tabelle~\ref{tab:Enduser} auf der Seite \pageref{tab:Enduser} geht auch.
%		\begin{itemize}
%			\item Vor- und Nachteile
%			\item Einsatz
%		\end{itemize}
%	
%	\section{Weiterer Text}
%		\subsection{Text}
%		Das ist weiterer Text.
%		Die Arbeit ist zu $\frac{1}{85726942537}$ geschrieben.
%	
